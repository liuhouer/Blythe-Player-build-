  ...
  try
    ...
    if Ptr <> nil then
      ...
      begin
        ...
        begin
          FIniFile.Add(String(Str));
          if (Str[1] = '[') and (Str[Length(Str)] = ']') then
          begin
            FSections.AddObject(Trim(String(Str)),TObject(I));
          end;
          inc(I);
        end;
...
begin
  ...
  try
    ...
    begin
      I := GetSectionIndex(String(Section));
      if I <> -1 then
      begin
        Inc(I);
