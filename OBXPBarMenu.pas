...
begin
  ...
  FBarColorStart := clBlack; /// The First Color
  FBarColorEnd := $004F4F4F; /// The Second Color
  FBarColorStep := 100;
  FBarFont := TFont.Create; /// Bar Text Font
  FBarFont.Assign(FFont); /// Bar Font Init
  FBarFont.Name := 'Arial';
  FBarFont.Height := -12;
  FBarFont.Style := [fsBold,fsItalic];
  FBarFont.Charset := ANSI_CHARSET;
